              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <?php
                              ...
                              $sql="SELECT ID , User_name , User_email , Total_Post FROM user
                              INNER JOIN (SELECT User_id, COUNT(Post_id) as Total_Post FROM post GROUP BY User_id)
                              as al ON ID = al.User_id";
                              $result=mysqli_query($conn,$sql);
